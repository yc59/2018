...
- As a programmer, you have an obligation to determine if your code performs as you desire
...
## Useful tool for your task: R Studio debugger

An extensive _how to_ description of using the R Studio interactive debugger is at the [R Studio support website](https://support.rstudio.com/hc/en-us/articles/205612627-Debugging-with-RStudio).  Using the debugger consists of pausing execution of your code.  This is done in one of several ways 

- breakpoints - places in your code where you wish execution to pause.  These can be set using
    - editor window and mouse  ![image](screen1.png)
...
### A review you can watch at home
[A 10-minute video produced by the R-Studio folks describing the use of their debugger.](https://vimeo.com/99375765)
